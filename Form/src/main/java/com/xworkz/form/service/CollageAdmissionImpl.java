...
public class CollageAdmissionImpl implements CollageAdmissionService {
	

	public boolean validateAndSave(CollegeAdmissionDTO collegeAddmissionDTO) {
		...
		boolean valid = true;
			...
			String mobile = String.valueOf(collegeAddmissionDTO.getMobile());
			...
			String percentage =String.valueOf(collegeAddmissionDTO.getPercentage()) ;
